window.introductionGenerator = (() => {
    ...
    function generateIntroductionHTML(stats, commonData) {
        ...
        const introText = `
            ...
            <p>The purpose of this study was twofold: first, to compare the diagnostic performance of the Avocado Sign against a computationally optimized, data-driven T2-based benchmark to assess its added value within our cohort; and second, to contextualize its performance by comparing it against established, literature-based T2 criteria.</p>
        `;
