window.discussionGenerator = (() => {
    ...
    function generateDiscussionHTML(stats, commonData) {
        ...
        if (!overallStats || !overallStats.performanceAS) {
            return '<h3 id="discussion_main">Discussion</h3><p class="text-warning">Discussion could not be generated due to missing statistical data.</p>';
        }
        ...
        const reproducibilityParagraph = `
            <p>The straightforward application of the Avocado Sign is a key advantage. Unlike complex multi-feature assessments, its binary nature contributes to high reproducibility, as reflected in the previously reported ${kappaText} interobserver agreement for this cohort ${helpers.getReference('Lurz_Schaefer_2025')}. This suggests that the sign can be reliably assessed by radiologists with varying levels of expertise. Its integration requires only routine high-resolution, fat-saturated contrast-enhanced T1-weighted sequences, making it easily incorporable into standard MRI protocols without significant workflow changes.</p>
        `;
