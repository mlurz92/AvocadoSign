window.discussionGenerator = (() => {
    ...
    function generateDiscussionHTML(stats, commonData) {
        ...
        const contextParagraph = `
            <p>The limitations of conventional T2 criteria are well-documented, with prior meta-analyses reporting suboptimal diagnostic accuracy ${helpers.getReference('Al_Sukhni_2012')}${helpers.getReference('Zhuang_2021')}. Our results align with these findings, which are underscored by the large prospective OCUM trial that reported an accuracy of only 56.5% for T2-based nodal staging and consequently favored treatment decisions based on mesorectal fascia status ${helpers.getReference('Stelzner_2022')}. Furthermore, the prognostic landscape itself is evolving. Lord et al. have compellingly argued that tumor deposits, often indistinguishable from lymph nodes on T2-weighted images, may represent a more aggressive pathway of venous invasion and hold greater prognostic weight than true nodal metastases ${helpers.getReference('Lord_2019')}. We postulate that the Avocado Sign, as a marker of altered vascularity and central necrosis, may be particularly adept at identifying these prognostically significant deposits in addition to true metastases, potentially explaining its superior performance over purely morphologic criteria. This robustness is further supported by its almost perfect interobserver agreement (Cohen’s kappa = ${helpers.formatValueForPublication(overallStats?.interobserverKappa?.value, 2, false, true)}), indicating it is a simple and highly reproducible marker ${helpers.getReference('Lurz_Schaefer_2025')}.</p>
        `;
